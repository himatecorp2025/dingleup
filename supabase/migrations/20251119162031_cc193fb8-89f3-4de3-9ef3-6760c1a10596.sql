-- Drop and recreate regenerate_lives_background() with speed token support
...
BEGIN
  ...
  LOOP
    ...
    -- Check for active speed token (2x faster regeneration)
    SELECT EXISTS (
      SELECT 1 
    ...
    -- FIXED: Proper type handling for last_life_regeneration
    -- Ensure we're always working with TIMESTAMP WITH TIME ZONE
    ...
    -- FIXED: Both sides are now explicitly TIMESTAMP WITH TIME ZONE
