-- Update regenerate_lives_background to treat both is_subscribed and is_subscriber as subscriber
...
BEGIN
  ...
  LOOP
    -- Determine base values based on subscription (support both flags)
