-- Fix regenerate_lives_background() function to properly handle timestamp comparisons
...
BEGIN
  ...
  LOOP
    ...
    -- CRITICAL: Ensure last_life_regeneration is properly typed as TIMESTAMP WITH TIME ZONE
