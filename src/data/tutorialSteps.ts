...
export const tutorialSteps = {
  ...
  gifts: [
    {
      target: '[data-tutorial="gifts-container"]',
      title: {
        hu: 'Ajándékok 🎁',
        en: 'Gifts 🎁'
      },
      description: {
        hu: 'Üdvözlünk az Ajándékok oldalon! Itt találod meg az összes ajándékdobozodat és vásárolhatsz újakat. Kezdjük!',
        en: 'Welcome to the Gifts page! Here you find all your gift boxes and can purchase new ones. Let\'s start!'
      },
      position: 'center' as const
    },
    {
      target: '[data-tutorial="stored-lootboxes"]',
      title: {
        hu: 'Tárolt Ajándékdobozok 📦',
        en: 'Stored Gift Boxes 📦'
      },
      description: {
        hu: 'Itt látod az összes megszerzett ajándékdobozodat. Kattints egy dobozra a megnyitáshoz! Minden doboz megnyitásához 150 arany szükséges, és értékes jutalmakat tartalmaz.',
        en: 'Here you see all your acquired gift boxes. Click a box to open it! Opening each box costs 150 gold and contains valuable rewards.'
      },
      position: 'bottom' as const
    },
    {
      target: '[data-tutorial="purchase-packages"]',
      title: {
        hu: 'Új Ajándékok Vásárlása 💳',
        en: 'Purchase New Gifts 💳'
      },
      description: {
        hu: 'Válassz különböző ajándékcsomag opciók közül! Minél nagyobb csomagot vásárolsz, annál több ajándékdobozt kapsz. Minden doboz garantált aranyat és életeket tartalmaz.',
        en: 'Choose from different gift package options! The larger the package you buy, the more gift boxes you get. Each box contains guaranteed gold and lives.'
      },
      position: 'top' as const
    },
    {
      target: '[data-tutorial="back-dashboard"]',
      title: {
        hu: 'Vissza a Dashboard-ra',
        en: 'Back to Dashboard'
      },
      description: {
        hu: 'Ha végeztél az ajándékok kezelésével, ezzel a gombbal visszatérhetsz a főoldalra.',
        en: 'When you\'re done managing gifts, use this button to return to the main page.'
      },
      position: 'bottom' as const
    },
    {
      ...
      description: {
        hu: 'Most már ismered az Ajándékok oldalt! Nyisd ki dobozaidat, vagy vásárolj újakat. Sok szerencsét! 🍀',
        en: 'Now you know the Gifts page! Open your boxes or purchase new ones. Good luck! 🍀'
      },
      position: 'center' as const
    }
  ]
