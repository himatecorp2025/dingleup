...
const Login = () => {
  ...
  return (
    <div className="min-h-screen min-h-dvh fixed inset-0 flex justify-center items-start sm:items-center px-4 pt-3 pb-4 sm:py-12 overflow-y-auto" style={{ background: 'transparent' }}>
      {/* Overlay gradients */}
