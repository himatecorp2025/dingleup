  ...
  <div className="h-screen w-screen bg-gradient-to-b from-[#0a0a2e] via-[#16213e] to-[#0f0f3d] overflow-hidden fixed inset-0" style={{
    ...
    <FallingCoins />
      ...
      <div className="h-full w-full flex flex-col overflow-y-auto overflow-x-hidden px-3 py-2 max-w-screen-lg mx-auto relative z-10" style={{ paddingBottom: 'calc(var(--bottom-nav-h) + env(safe-area-inset-bottom) + 100px)' }}>
        ...
        {/* Leaderboard Carousel - Top 25 players - Fixált az alsó menüsáv fölé 5% távolsággal */}
        <div className="fixed left-0 right-0 z-40" style={{ bottom: 'calc(var(--bottom-nav-h) + env(safe-area-inset-bottom) + 5vh)' }}>
          <LeaderboardCarousel />
        </div>
