...
const RegisterNew = () => {
  ...
  return (
    <div 
      className="h-dvh w-screen relative overflow-hidden bg-gradient-to-br from-[#1a0033] via-[#2d1b69] to-[#0f0033] flex items-center justify-center"
      style={{
    ...
    >
      ...
      <div className="w-[90vw] h-[90vh] max-w-[500px] relative z-10 flex items-center justify-center">
