  ...
  return (
    <div className={`relative ${className}`} style={{ minWidth: '320px', minHeight: '100px' }}>
      ...
      <svg 
        ...
        viewBox="22.53058 -47.5814116 672.82399 300"
        fill="none"
      ...
      >
        <defs>
          ...
          <linearGradient id="bg_2" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#191534"/>
            <stop offset="100%" stopColor="#0e0b1c"/>
          </linearGradient>

          <linearGradient id="chromeGrad_2" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="band20_2" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#BFE0FF"/>
            <stop offset="35%" stopColor="#2196F3"/>
            <stop offset="100%" stopColor="#0B5DB8"/>
          </linearGradient>

          <linearGradient id="band5_2" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#E6F2FF"/>
            <stop offset="50%" stopColor="#5AB6FF"/>
            <stop offset="100%" stopColor="#1E74D6"/>
          </linearGradient>

          <filter id="pro3d_2" x="-50%" y="-50%" width="200%" height="200%">
          ...
          <mask id="maskOuterOnly_2" maskUnits="userSpaceOnUse">
        ...
        <g transform="scale(1,1.45)">
          ...
          <use href="#HEX" fill="none" stroke="url(#band20_2)" strokeWidth="20"
               strokeLinejoin="miter" strokeMiterlimit="200" strokeLinecap="butt" filter="url(#pro3d_2)"
               vectorEffect="non-scaling-stroke"/>

          <use href="#HEX" fill="none" stroke="url(#band5_2)" strokeWidth="5"
               strokeLinejoin="miter" strokeMiterlimit="200" strokeLinecap="butt" filter="url(#pro3d_2)"
               vectorEffect="non-scaling-stroke"/>

          <g mask="url(#maskOuterOnly_2)">
            <use href="#HEX" fill="none" stroke="url(#chromeGrad_2)" strokeWidth="2"
      ...
      {/* Rank Hexagon - Blue */}
      <div className="absolute z-10" style={{ left: '20%', top: '36%', transform: 'translate(-50%, -50%)' }}>
      ...
      {/* Lives Hexagon - Red */}
      <div className="absolute z-10" style={{ left: '60%', top: '36%', transform: 'translate(-50%, -50%)' }}>
        <DiamondHexagon type="lives" value={lives} />
      </div>

      {/* Avatar Hexagon - Purple */}
      <div className="absolute z-10" style={{ left: '80%', top: '36%', transform: 'translate(-50%, -50%)' }}>
        <DiamondHexagon 
          type="avatar" 
          value={username} 
          avatarUrl={avatarUrl}
