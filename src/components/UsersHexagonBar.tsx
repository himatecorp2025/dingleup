    ...
    <div className={`relative ${className}`} style={{ minWidth: '320px', minHeight: '100px' }}>
      ...
      >
        <defs>
          ...
          <linearGradient id="bg_4" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#191534"/>
            <stop offset="100%" stopColor="#0e0b1c"/>
          </linearGradient>

          <linearGradient id="chromeGrad_4" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="band20_4" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#BFE0FF"/>
            <stop offset="35%" stopColor="#2196F3"/>
            <stop offset="100%" stopColor="#0B5DB8"/>
          </linearGradient>

          <linearGradient id="band5_4" x1="0" y1="-47.58" x2="0" y2="119.78" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#E6F2FF"/>
            <stop offset="50%" stopColor="#5AB6FF"/>
            <stop offset="100%" stopColor="#1E74D6"/>
          </linearGradient>

          <filter id="pro3d_4" x="-50%" y="-50%" width="200%" height="200%">
          ...
          <mask id="maskOuterOnly_4" maskUnits="userSpaceOnUse">
        ...
        <g transform="scale(1,1.44)">
          ...
          <use href="#HEX" fill="none" stroke="url(#band20_4)" strokeWidth="20"
               strokeLinejoin="miter" strokeMiterlimit="200" strokeLinecap="butt" filter="url(#pro3d_4)"
               vectorEffect="non-scaling-stroke"/>

          <use href="#HEX" fill="none" stroke="url(#band5_4)" strokeWidth="5"
               strokeLinejoin="miter" strokeMiterlimit="200" strokeLinecap="butt" filter="url(#pro3d_4)"
               vectorEffect="non-scaling-stroke"/>

          <g mask="url(#maskOuterOnly_4)">
            <use href="#HEX" fill="none" stroke="url(#chromeGrad_4)" strokeWidth="2"
