    ...
    >
      ...
      <div className="relative z-10 text-center w-full">
        <div className="flex items-center justify-center gap-1.5 mb-0.5">
          ...
          <p className="text-[10px] sm:text-xs text-black font-black drop-shadow-[0_2px_4px_rgba(255,215,0,0.5)]">DÍJAZÁSIG</p>
        </div>
        <p className="text-xs sm:text-sm font-black text-black drop-shadow-[0_3px_6px_rgba(255,215,0,0.6)] leading-tight tracking-wider">
          {timeRemaining}
        </p>
      </div>
    </div>
