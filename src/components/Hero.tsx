          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mt-6 animate-fade-in" style={{ animationDelay: '0.7s' }}>
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs opacity-80">Letöltés az</p>
                <p className="font-bold">App Store-ból</p>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                <p className="text-xs opacity-80">Szerezd be</p>
                <p className="font-bold">Google Play-en</p>
              </div>
            </button>
          </div>
