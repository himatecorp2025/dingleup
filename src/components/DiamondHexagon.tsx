  ...
  return React.createElement(
    ...
    <>
      ...
      <div className="relative" style={{ width: 'clamp(48px, 7vh, 56px)', height: 'clamp(48px, 7vh, 56px)' }}>
        ...
        {type === 'avatar' ? (
          // Avatar Image - közvetlenül inset-x-[5px] inset-y-[4.5px], 1px nagyobb vertikálisan
          <div className="absolute inset-x-[5px] inset-y-[4.5px] flex items-center justify-center z-[5]">
            <img
