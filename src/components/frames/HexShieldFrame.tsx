  ...
  return (
    <div className={`relative overflow-hidden ${className}`}
      ...
      <svg viewBox="0 0 360 600" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid meet" aria-hidden>
        ...
        <path
          d="M 180 91 L 336 150 L 336 450 L 180 509 L 24 450 L 24 150 Z"
        ...
        <path
          d="M 180 101 L 324 158 L 324 442 L 180 499 L 36 442 L 36 158 Z"
          fill="url(#goldInner)"
        ...
        <path
          d="M 180 111 L 312 166 L 312 434 L 180 489 L 48 434 L 48 166 Z"
