      ...
      case 'none':
        return (
          <button 
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-br from-blue-600/30 to-purple-700/30 hover:from-blue-600/40 hover:to-purple-700/40 border border-blue-500/50 rounded-lg transition-colors text-sm shadow-lg shadow-blue-500/20"
          >
            <UserPlus className="w-4 h-4 text-blue-300" />
            <span className="text-blue-300 font-medium">Bejelölöm</span>
          </button>
        );
      case 'pending_sent':
        return (
        ...
        return (
          <div className="flex items-center gap-2">
            <button 
              ...
              className="px-3 py-1.5 bg-gradient-to-br from-blue-700 via-purple-700 to-purple-900 hover:from-blue-600 hover:via-purple-600 hover:to-purple-800 text-white rounded-lg text-sm shadow-lg shadow-purple-500/30"
            >Elfogadom</button>
            <button 
        ...
        <div className="flex items-end gap-2 max-w-4xl mx-auto w-full" style={{ maxWidth: '100%' }}>
          ...
          {messageText.trim() ? (
            <button
              ...
              className="p-2.5 bg-gradient-to-br from-blue-700 via-purple-700 to-purple-900 hover:from-blue-600 hover:via-purple-600 hover:to-purple-800 rounded-full transition-all duration-200 flex-shrink-0 mb-1 shadow-lg shadow-purple-500/30 disabled:opacity-50"
              aria-label="Küldés"
              disabled={!permsLoading && !canSend}
            >
