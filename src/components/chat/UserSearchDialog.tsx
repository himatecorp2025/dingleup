      ...
      case 'not_friend':
        return (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-br from-blue-700 via-purple-700 to-purple-900 hover:from-blue-600 hover:via-purple-600 hover:to-purple-800 rounded-lg text-white text-sm font-medium transition-all shadow-lg shadow-purple-500/30"
          >
                  ...
                  {allRequests.map((request) => {
                    const getStatusBadge = () => {
                      switch (request.status) {
                        ...
                        case 'active':
                          return <span className="px-2 py-1 bg-gradient-to-br from-blue-600/30 to-purple-700/30 border border-blue-500/50 rounded text-xs text-blue-300">Elfogadva</span>;
                        case 'declined':
                      ...
                      >
                        ...
                        {request.status === 'pending' && (
                          <div className="flex gap-2">
                            <button
                              ...
                              className="p-2 bg-gradient-to-br from-blue-700 via-purple-700 to-purple-900 hover:from-blue-600 hover:via-purple-600 hover:to-purple-800 rounded-lg transition-all shadow-lg shadow-purple-500/30"
                        ...
                        {request.status === 'active' && (
                          <button
                            ...
                            className="px-3 py-1.5 bg-gradient-to-br from-blue-700 via-purple-700 to-purple-900 hover:from-blue-600 hover:via-purple-600 hover:to-purple-800 rounded-lg text-white text-sm font-medium transition-all shadow-lg shadow-purple-500/30"
                          >
                            <MessageCircle className="w-4 h-4" />
                          </button>
                        )}
