  ...
  if (gameState === 'category-select') {
    return (
      <div className="relative">
        ...
        {/* Stats overlay */}
        <div className="fixed top-4 right-4 bg-card/90 backdrop-blur-sm rounded-2xl p-4 border border-border/50 shadow-lg">
          <div className="flex flex-col gap-2">
            ...
            {canClaim && (
              <Button size="sm" onClick={claimDailyGift} className="mt-2">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/10 p-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 bg-card/90 backdrop-blur-sm rounded-full px-4 py-2">
                <Heart className="w-5 h-5 text-red-500" />
                <span className="font-bold">{profile.lives}</span>
              </div>
              <div className="flex items-center gap-2 bg-card/90 backdrop-blur-sm rounded-full px-4 py-2">
                <Coins className="w-5 h-5 text-yellow-500" />
                <span className="font-bold">{profile.coins + coinsEarned}</span>
              </div>
            </div>
          </div>

          {/* Progress */}
          <div className="bg-card/90 backdrop-blur-sm rounded-2xl p-4 mb-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium">Kérdés {currentQuestionIndex + 1}/15</span>
              <div className="flex items-center gap-2">
          ...
          {/* Question */}
          <div className="bg-card/90 backdrop-blur-sm rounded-2xl p-6 mb-6">
  ...
  if (gameState === 'finished') {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-background to-accent/10">
        <div className="max-w-md w-full bg-card/90 backdrop-blur-sm rounded-2xl p-8 text-center">
          <Trophy className="w-16 h-16 mx-auto mb-4 text-yellow-500" />
          <h1 className="text-3xl font-bold mb-4">Játék vége!</h1>
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="bg-accent/50 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold">+{coinsEarned} 🪙</p>
            </div>
          </div>
