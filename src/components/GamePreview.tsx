...
const handleAnswer = (answerIndex: number) => {
    ...
    if (hasDoubleAnswer) {
      if (firstAttemptIndex === null) {
        ...
        if (isCorrect || firstWasCorrect) {
          ...
          // 1 mp késleltetés mielőtt a swipe indikátor vagy következő megjelenik
          setTimeout(() => {
          ...
          setSelectedAnswer(questions[currentQuestion].correctIndex);
          // 1 mp késleltetés mielőtt a popup megjelenik
          setTimeout(() => {
    ...
    if (isCorrect) {
      ...
      // Rossz válasz - 1 mp késleltetés mielőtt a popup megjelenik
      setTimeout(() => {
        setShowWrongAnswerPopup(true);
      }, 1000);
    }
