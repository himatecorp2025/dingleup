...
export const InGameRescuePopup: React.FC<InGameRescuePopupProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-[95vw] w-full h-[50vh] overflow-y-auto bg-gradient-to-br from-red-900/40 via-purple-900/60 to-red-900/40 border-[3px] border-yellow-500/80 p-3 shadow-2xl shadow-yellow-500/50 rounded-xl fixed top-[50vh] left-[50vw] -translate-x-1/2 -translate-y-1/2 m-0">
        {/* Header */}
