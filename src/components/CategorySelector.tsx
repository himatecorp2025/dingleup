...
const CategorySelector = ({ onSelect }: CategorySelectorProps) => {
  ...
  return (
    <div className="category-selector h-dvh h-svh w-screen flex flex-col items-start justify-start p-4 pt-12 bg-gradient-to-b from-[#0a0a2e] via-[#16213e] to-[#0f0f3d] overflow-hidden fixed inset-0">
