...
export const QuestionCard = ({
  ...
  return (
    <div className={`w-full h-full flex flex-col pt-0 px-2 sm:px-3 md:px-4 pb-2 gap-0 ${className}`}>
      ...
      <div className="flex flex-col justify-start space-y-1 sm:space-y-1.5 md:space-y-2 mt-[3vh] sm:mt-[4vh] md:mt-[5vh]">
        <div className="flex justify-center -mt-8 sm:-mt-10 md:-mt-12">
          <TimerCircle timeLeft={timeLeft} />
        </div>

        <div className="-mt-1 sm:-mt-2 md:-mt-3 pb-5 sm:pb-6 md:pb-8">
